    ...
    public void CreateAcc() throws InterruptedException {
        ...
        for (String windowHandel : allWindows){
            if (!windowHandel.equals(mainWindowHandel)){
                ...
                createAccountPage.setFirstNameField("Lokeshwaran");
                ...
                Thread.sleep(2000);
                createAccountPage.setEmailField("Lokki1997@gmail.com");
                createAccountPage.setCPasswordField("Lokki@0412");
                createAccountPage.setNewPasswordField("Lokki@0412");
